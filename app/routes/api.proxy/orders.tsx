...
//       store.accessToken,
//     )
//     const locationIds = companyLocations.locations.map(
...
//       companyId: company.companyId,
//       allowedLocationIds,
//         // userData?.role == "STORE_ADMIN" ? locationIds : allowedLocationIds,
//       filters: queryFilters,
//       pagination: pagination || { first: 20 },
//     });
//     console.log(result.orders?.length, "result");
...
//       },
//     );
//       const currentMonthOrders = await prisma.b2BOrder.groupBy({
//       by: ["shopifyOrderId"],
//       where: {
//         orderStatus: {
//           not: "cancelled",
...
//         companyId: companyData.id,
//         shopifyOrderId: {
//           in: currentMonthResult.orders?.map((order:any) => order.id),
//         },
//       },
...
//       },
//     );
//        const previousMonthOrders = await prisma.b2BOrder.groupBy({
//       by: ["shopifyOrderId"],
//       where: {
//         orderStatus: {
//           not: "cancelled",
...
//         companyId: companyData.id,
//         shopifyOrderId: {
//           in: previousMonthResult.orders?.map((order:any) => order.id),
//         },
//       },
    
//     });

//     const ordersCurrentMonth = currentMonthOrders.length|| 0;
//     const ordersPreviousMonth = previousMonthOrders.length || 0;
